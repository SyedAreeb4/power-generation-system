  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text('WIND POWER PLANT', style: TextStyle(fontSize: 20)),
      ),
      backgroundColor: const Color.fromARGB(255, 7, 231, 209),
      body: Padding(
